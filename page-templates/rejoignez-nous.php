...
if ( is_active_sidebar( 'rejoignez-nous-cta-don' ) ) {
	dynamic_sidebar( 'rejoignez-nous-cta-don' );
} else {
	get_template_part(
...
if ( is_active_sidebar( 'rejoignez-nous-cta-courir' ) ) {
	dynamic_sidebar( 'rejoignez-nous-cta-courir' );
} else {
	get_template_part(
...
if ( is_active_sidebar( 'rejoignez-nous-cta-collecte' ) ) {
	dynamic_sidebar( 'rejoignez-nous-cta-collecte' );
} else {
	get_template_part(
		'template-parts/marketing/horizontal-push',
		null,
...
if ( is_active_sidebar( 'rejoignez-nous-cta-benevole' ) ) {
	dynamic_sidebar( 'rejoignez-nous-cta-benevole' );
} else {
	get_template_part(
		'template-parts/marketing/horizontal-push',
		null,
...
if ( is_active_sidebar( 'rejoignez-nous-cta-partenaire' ) ) {
	dynamic_sidebar( 'rejoignez-nous-cta-partenaire' );
} else {
	get_template_part(
		'template-parts/marketing/horizontal-push',
		null,
...
if ( is_active_sidebar( 'rejoignez-nous-cta-closing' ) ) {
	dynamic_sidebar( 'rejoignez-nous-cta-closing' );
} else {
	get_template_part(
